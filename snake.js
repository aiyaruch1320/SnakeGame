//todo: log -> snake.size, snake.tail[snake.tail.length - 1], snake.tail[i].x, snake.tail[i].y
//research about -> Math.floor, Math.random
//เรื่องที่สงสัย : มันทะลุกำแพงไปโผล่อีกฝั่งได้ยังไง?, กินแอปเปิ้ลยังไง?, ตัวมันยาวขึ้นได้ยังไง?, การสร้างทิศทาง (move())
